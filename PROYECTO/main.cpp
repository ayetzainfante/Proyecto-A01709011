...
using namespace std;
string gmail,user,password,fecha, hora, nom, country,respuesta,date,remitente,remitenteLugar,destinatarioLugar,paises,destinatario,name,motivo;
string s1;
float valor,tarifa;
        ...
        cin>> opcion;
            ...
            cout<<"\n";
                ...
                else if(respuesta=="2")
                {
                    ...
                    cout<<"------------------------------------------------------------"<<endl;
                    cout<<"\n";
                    cout<< "Felicidades "<<user<<", sus datos han sido ingresados con exito"<<endl;
                    cout<<"\n";
                    cout<<"Nombre: "<<nom<<endl;
                    cout<<"\n";
                    cout<<"Correo electronico proporcionado: "<<gmail<<endl;
                    cout<<"\n";
                    cout<<"Numero telefonico: "<<tel<<endl;
                    cout<<"\n";
                    cout<<"ID de usuario: "<<user<<endl;
                    cout<<"\n";
                    cout<<"------------------------------------------------------------"<<endl;
                }
    }
